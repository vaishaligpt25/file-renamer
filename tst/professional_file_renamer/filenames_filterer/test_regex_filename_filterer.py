...
class TestRegexFilenameFilterer(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ("filter_multiple_files", ["file1.txt", "goojy.java", "file2.txt", "file3.doc", "poncho.py"], r"file",
        ...
        ("filter_multiple_files", ["file1.txt", "goojy.java", "file2.txt", "file3.doc", "poncho.py", "ile.poncho"],
         r".*ile",
         ["file1.txt", "file2.txt", "file3.doc", "ile.poncho"])
    ])
    # Test method:
